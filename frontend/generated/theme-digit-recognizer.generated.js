...
import stylesCss from 'themes/digit-recognizer/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_digit-recognizer_componentCss']) {
    
    document['_vaadintheme_digit-recognizer_componentCss'] = true;
  }
